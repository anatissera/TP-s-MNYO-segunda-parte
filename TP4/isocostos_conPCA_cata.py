...
plt.subplot(1, 2, 1)
plt.contour(xx_pca, yy_pca, Z_pca, levels=levels, cmap='rainbow')
plt.plot(history_F_pca[:, 0], history_F_pca[:, 1], 'o-', color='red', label='Trayectoria GD')
...
plt.subplot(1, 2, 2)
plt.contour(xx_pca, yy_pca, Z_pca, levels=levels, cmap='rainbow')
plt.plot(history_F2_pca[:, 0], history_F2_pca[:, 1], 'o-', color='red', label='Trayectoria GD Regularizado')
