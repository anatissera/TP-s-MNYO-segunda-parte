...
def main():
    ...
    plot_prediction_errors(X, labels)
    
    X_pseudo_inv, beta, error = svd_least_squares_PCA(X, labels, 2)
    plot_beta_weights(beta)
    
    X_pseudo_inv, beta, error = svd_least_squares_PCA(X, labels, 3)
    plot_beta_weights(beta)
    
    X_pseudo_inv, beta, error = svd_least_squares_PCA(X, labels, 103)
    plot_beta_weights(beta)
